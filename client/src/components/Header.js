...
const Header = () => {
    ...
    return (
            ...
            //     <ul class="nav justify-content-center mt-2 header">
            //         <li class="nav-item">
            ...
            <div className="col-md-12">
                <ul className="nav justify-content-center header">
                    <li className="nav-item">
                        <a className="nav-link active p-4 m-3" href="#">Home</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link active p-4 m-3" href="#">Albums</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link active p-4 m-3" href="#">About</a>
                    </li>
                </ul>
            </div>
